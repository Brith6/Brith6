...
> IFTTT/Zapier-style action-reaction engine.
> **Django REST** + async execution (Threading & Polling).
> Full **OAuth2**: Google, Discord, GitHub.
>
...
> Networked multiplayer engine from scratch in C++.
> **ECS** architecture (Entity Component System) over **TCP/UDP**.
>
